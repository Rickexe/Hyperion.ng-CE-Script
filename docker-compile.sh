...
sudo rm -fr $SCRIPT_PATH/hyperion.test >/dev/null 2>&1
git clone --recursive --depth 1 -q $GIT_REPO_URL $SCRIPT_PATH/hyperion.test || { echo "---> Failed to download Hyperion source code! Abort"; exit 1; }
